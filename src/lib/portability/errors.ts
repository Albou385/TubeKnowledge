export const PUBLIC_PORTABILITY_ERRORS = {
  ...
  STALE_BASELINE_RECONCILE_NOT_ALLOWED: "La réconciliation de la baseline locale n’est pas autorisée dans l’état actuel.",
  STALE_BASELINE_RECONCILE_CONFIRMATION_REQUIRED: "La confirmation exacte RECONCILIER ET REACQUERIR est requise.",
