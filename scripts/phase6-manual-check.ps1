...
try { & node.exe 'node_modules/tsx/dist/cli.mjs' 'scripts/phase6-operational-manual-check.ts'; if ($LASTEXITCODE -ne 0) { throw 'Controle manuel Phase 6.1 echoue.' } } finally { Pop-Location }
